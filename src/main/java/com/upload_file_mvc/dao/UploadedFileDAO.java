...
public class UploadedFileDAO {
    ...
    public int getFileCountByUserId(int userId) {
        String sql = "SELECT COUNT(*) FROM uploaded_files WHERE user_id = ?";
    ...
    public long getTotalStorageByUserId(int userId) {
        String sql = "SELECT SUM(file_size) FROM uploaded_files WHERE user_id = ?";
